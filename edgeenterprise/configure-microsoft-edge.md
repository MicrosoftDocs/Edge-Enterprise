...
Use the following information to configure Microsoft Edge policy settings on your Windows devices. If you haven’t set up Microsoft Edge, see the [Microsoft Edge setup guide](https://go.microsoft.com/fwlink/?linkid=2187484).
