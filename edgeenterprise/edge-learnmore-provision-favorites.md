...
3. Navigate to the Favorites management page at *edge://favorites* and start adding the favorites and folders that you want to provision. The folder structure of favorites that are set in the profile you're using will be reflected in the folder you provision for your users.  
