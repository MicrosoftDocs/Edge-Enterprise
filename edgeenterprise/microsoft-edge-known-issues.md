...
| --- | --- | --- | --- |
| 130 | Starting with Microsoft Edge Stable version 130.0.2849.46, some browser extensions are no longer working if they are using the chrome.storage.managed API. | Roll back Microsoft Edge to version 129.0.2792.89. | This is under investigation at the highest priority level. An update will be provided once Microsoft determines which Edge stable release will address the issue. |
