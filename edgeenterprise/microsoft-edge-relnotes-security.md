...
Microsoft has a fix for [CVE-2024-7965](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-7965) to **Microsoft Edge Stable Channel (Version 128.0.2739.54)** which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## August 22, 2024

Microsoft has a fix for [CVE-2024-7971](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-7971) to **Microsoft Edge Stable Channel (Version 128.0.2739.42)** which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
