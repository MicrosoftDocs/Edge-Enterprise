...
Microsoft has released the latest **Microsoft Edge Extended Stable Channel (Version Version 114.0.1722.xx)** which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
