...
[Microsoft Edge SmartScreen](//DeployEdge/microsoft-edge-security-smartscreen) blocked 92.3% of phishing attempts during the  [CyberRatings.org Web Browsers vs. Phishing](https://aka.ms/EdgePhishingReport)  test and 97.4% of malware attempts during the [CyberRatings.org Web Browsers vs. Malware](https://aka.ms/EdgeMalwareReport) test compared to Chrome's Safe Browsing's rates of 84.6% and 86.3%, respectively.
