...
To deploy an MSI with Microsoft Endpoint Manager, see the [Create and Deploy an Application with Configuration Manager](https://docs.microsoft.com/en-us/mem/configmgr/apps/get-started/create-and-deploy-an-application) guide. During the Create Application Wizard step, add the `ALLOW_DOWNGRADE=1` option to the Installation Program, e.g. `msiexec /I FileName.msi /qn ALLOWDOWNGRADE=1`.
