...
**Password strength and reuse**.  Microsoft Edge now lets you know whether the password you’ve saved is strong enough and tells you whether you've used that password on other sites.
